        ...
        <div className={`modal-finish${props.modalMesMissionIsOpen ? " active" : ""}`}>
            ...
            <div className="modal-finish__first-state">
                ...
                <div className="modal-finish__recap">
                    ...
                    <button className="modal-finish__recap-submit" onClick={(e) => (submitButton(e))}>Valide ta mission</button>
                ...
                <div className="modal-finish__second-state">
                    ...
                    <div className="modal-finish__second-state-content">
                        ...
                        <button 
                            onClick={(e) => {
                                e.preventDefault();
                                props.setModalMesMissionIsOpen(false);
                                setState(1)
                            }}>Continue</button>
